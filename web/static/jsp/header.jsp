...
<nav class="navbar navbar-expand-md navbar-dark bg-gradient">
    <div class="container">
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
            <% if (user != null) {%>
            <%if (type == 1) {%>
            <a class="btn navbar-btn ml-2 btn-light text-success" href="/user/index.jsp"><%=username%>
            </a>
            <a class="btn navbar-btn ml-2 btn-light text-success" href="/index.jsp">&nbsp;退出登录</a>
            <%} else if (type == 2) {%>
            <a class="btn navbar-btn ml-2 btn-light text-success" href="/admin/index.jsp"><%=username%>
            </a>
            <a class="btn navbar-btn ml-2 btn-light text-success" href="/index.jsp">&nbsp;退出登录</a>
            <%
                }
