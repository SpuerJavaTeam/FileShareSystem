...
<head>
  ...
  <script>
    ...
    var valipassword = document.getElementById("password1");
    if (password.equals(valipassword)){
            ...
            <div class="card-body p-5">
              ...
              <form action="signUp.action" method="post">
                <div class="form-group">
                  ...
                  <input class="form-control" name="email" placeholder="请输入邮箱"> </div>

                <div class="form-group">
                  <label>用户名</label>

                  <input class="form-control" name="username" placeholder="请输入用户名"> </div>

                <div class="form-group">
                  <label>密码</label>

                  <input type="password" name="password" id="password" class="form-control" placeholder="请输入密码"> </div>
