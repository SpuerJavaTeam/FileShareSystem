...
<div class="container" id="box">
    <div class="row">
        <div class="col-lg-5" id="list">
            <ul class="list-group">
                <li class="list-group-item"><a onclick="showAtRight('Adminup.jsp')">上传文件</a></li>
                <li class="list-group-item"><a onclick="showAtRight('Adminupdatefile.jsp')">修改文件信息</a></li>
                <li class="list-group-item"><a onclick="showAtRight('Adminupdateuser.jsp')">修改用户信息</a></li>
